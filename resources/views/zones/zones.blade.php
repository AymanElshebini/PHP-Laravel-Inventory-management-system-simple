   ...
   <!--./Screen-->
                ...
                <div class="toolBar">
                    ...
                    <div class="toolBar-action">
                        ...
                        <form action="{{ route('zones.index') }}" method="get"  style="display: inline-block">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"> @lang('siteAr.add_zone') </h5>
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" name="name" id="name"
                                                           class="form-control"
                                                           placeholder="@lang('SiteAr.p_zone_name')"
